...
readenotes::readenotes(QWidget *parent) : QWidget(parent)
{
...
void readenotes:: read1_clicked(){
    QString file_name = QFileDialog::getOpenFileName(this,"Open a file","C:/Kushal/GAAKU/e_learning/text Files/e-notes");
...
void readenotes:: backclick_clicked(){
